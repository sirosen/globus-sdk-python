...
class AccessTokenAuthorizerFactory(AuthorizerFactory[AccessTokenAuthorizer]):
    ...
    def __init__(self, token_storage: ValidatingTokenStorage) -> None:
        ...
        self.token_storage.after_retrieve_validators.insert(
            0, self._check_expires_at_seconds
        )
    ...
    def _check_expires_at_seconds(self, token_data: TokenStorageData) -> None:
        """
...
class RefreshTokenAuthorizerFactory(AuthorizerFactory[RefreshTokenAuthorizer]):
    ...
    def __init__(
        ...
        self.token_storage.after_retrieve_validators.insert(
            0, self._check_has_refresh_token
        )

    def _check_has_refresh_token(self, token_data: TokenStorageData) -> None:
        """
        This is the before-validation hook set on the inner ValidatingTokenStorage.
